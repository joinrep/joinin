...
if(isset($_POST['event_id']) && isset($_POST['user_id']) && isset($_POST['participate'])) {
	...
	if ($participate == 'true') {
		...
		mysql_query("INSERT INTO Participate(joined_event, facebook_id) VALUES('$event_id', '$user_id')");
		...
		mysql_query("DELETE FROM Participate WHERE joined_event='$event_id' AND facebook_id='$user_id'");
